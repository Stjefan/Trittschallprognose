...
namespace Trittschallprognose
{
    ...
    public class SimpleDatabase
    {
        ...
        public SimpleDatabase()
        {
            ...
            // Ditraschicht.CreateInitialData();

            Bekotecschicht = new BekotecschichtModel();
            // Bekotecschicht.CreateInitialData();

            Daemmungschicht = new DaemmungschichtModel();
            // Daemmungschicht.CreateInitialData();

            Betonschicht = new BetonschichtModel();
            // Betonschicht.CreateInitialData();

            ReadFromCSV(@"C:\Users\stsch\source\repos\Trittschallprognose\Trittschallprognose\Resources\SampleDatabse.txt");
